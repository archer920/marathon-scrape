        ...
        try {
            while (!shutdown){
                when(source){
                    ...
                    MarathonSources.Moscow -> logger.printProgress("Moscow", source, 4032, 5554, 7820, 7882)
                    ...
                    MarathonSources.Toronto -> logger.printProgress("Toronto", source, 1505, 1359, 1496, 1185)
