...
class TrevisoTdsLiveComponent(@Autowired tdsLiveScraper: TdsLiveScraper,
        ...
        listOf(
                TdsScrapeInfo(Gender.UNASSIGNED, null, SequenceLinks(2014, "https://www.tds-live.com/ns/index.jsp?serviziol=&pageType=1&id=5771&servizio=000", 184), nationality = 6, ageGender = 7, finishTime = 8),
                TdsScrapeInfo(Gender.UNASSIGNED, null, SequenceLinks(2015, "https://www.tds-live.com/ns/index.jsp?serviziol=&pageType=1&id=6489&servizio=000", 156), nationality = 6, ageGender = 7, finishTime = 8)))
