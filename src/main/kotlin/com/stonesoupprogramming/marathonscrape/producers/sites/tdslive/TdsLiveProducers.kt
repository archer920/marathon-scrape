...
class RomeProducer(@Autowired tdsLiveScraper: TdsLiveScraper,
        ...
        listOf(
                ...
                TdsScrapeInfo(Gender.UNASSIGNED, null, SequenceLinks(2015, "https://www.tds-live.com/ns/index.jsp?serviziol=&pageType=1&id=6504&servizio=000", 1149)),
                ...
                TdsScrapeInfo(Gender.UNASSIGNED, null, SequenceLinks(2017, "https://www.tds-live.com/ns/index.jsp?login=&password=&is_domenica=0&nextRaceId=&dpbib=&dpcat=&dpsex=&serviziol=&pageType=1&id=8252&servizio=000&locale=1040", 1332))))