...
abstract class AbstractResultsPageProducer<T : AbstractColumnPositions>(protected val numberedResultsPageRepository: NumberedResultsPageRepository,
    ...
    @PostConstruct
    private fun init() {
        lastPageNum2014 = numberedResultsPageRepository.queryLastPage(2014, marathonSources)
        lastPageNum2015 = numberedResultsPageRepository.queryLastPage(2015, marathonSources)
        lastPageNum2016 = numberedResultsPageRepository.queryLastPage(2016, marathonSources)
        lastPageNum2017 = numberedResultsPageRepository.queryLastPage(2017, marathonSources)
        lastPageNum2018 = numberedResultsPageRepository.queryLastPage(2018, marathonSources)
    }
