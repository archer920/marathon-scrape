...
class PhiladelphiaXacteProducer(@Autowired private val xacteMarathonScraper: XacteMarathonScraper,
    ...
    private val scrapeInfo = PagedScrapeInfo<MergedAgedGenderColumPositions>(
...
@Component
class PhilidelphiaProducer(@Autowired private val philadelphiaAthProducer: PhiladelphiaAthProducer,
                           @Autowired private val philadelphiaXacteProducer: PhiladelphiaXacteProducer) :
        AbstractBaseProducer(LoggerFactory.getLogger(PhilidelphiaProducer::class.java), MarathonSources.Philadelphia) {
