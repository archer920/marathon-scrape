...
@Component
class QueenstownProducer(@Autowired athLinksMarathonScraper: AthLinksMarathonScraper,
                            @Autowired pagedResultsRepository: PagedResultsRepository) : BaseAthProducer(athLinksMarathonScraper, pagedResultsRepository,
        LoggerFactory.getLogger(QueenstownProducer::class.java),
        MarathonSources.Queenstown,
        mapOf(2014 to "https://www.athlinks.com/event/126740/results/Event/406785/Course/611233/Results",
                2015 to "https://www.athlinks.com/event/126740/results/Event/465427/Course/693521/Results",
                2016 to "https://www.athlinks.com/event/126740/results/Event/599000/Course/906836/Results",
                2017 to "https://www.athlinks.com/event/126740/results/Event/692748/Course/1122040/Results"))

@Component
class BigSurProducer(@Autowired athLinksMarathonScraper: AthLinksMarathonScraper,
                         @Autowired pagedResultsRepository: PagedResultsRepository) : BaseAthProducer(athLinksMarathonScraper, pagedResultsRepository,
        LoggerFactory.getLogger(BigSurProducer::class.java),
        MarathonSources.BigSur,
        mapOf(2014 to "https://www.athlinks.com/event/22927/results/Event/304970/Course/558494/Results",
...
@Component
class KaiserPermaneteProducer(@Autowired athLinksMarathonScraper: AthLinksMarathonScraper,
                        @Autowired pagedResultsRepository: PagedResultsRepository) : BaseAthProducer(athLinksMarathonScraper, pagedResultsRepository,
        LoggerFactory.getLogger(KaiserPermaneteProducer::class.java),
        MarathonSources.KaiserPermanete,
        mapOf(2014 to "https://www.athlinks.com/event/20168/results/Event/380936/Course/564144/Results",
                2015 to "https://www.athlinks.com/event/20168/results/Event/410400/Course/627824/Results",
                2016 to "https://www.athlinks.com/event/20168/results/Event/506617/Course/753272/Results",
                2017 to "https://www.athlinks.com/event/20168/results/Event/642814/Course/1005209/Results"))
